<template>
  <div>
    <!-- v-show="!showForm" -->
    <div>
      <gr-content-card v-apiauth:orgconfigdialog :url="apiUrls.list">
        <gr-form inline>
      ...
      <gr-content-card ref="tableContainer">
        <gr-col ref="tableHeader">
          <gr-button type="primary" class="el-icon-document-add" v-apiauth:orgconfigdialog :url="apiUrls.save"
            @click="showInfo('','create')">新增
          </gr-button>
          <gr-button type="danger" class="el-icon-delete" :disabled="loading" @click="doDelSelected"
            v-apiauth:orgconfigdialog :url="this.apiUrls.delete">删除所选</gr-button>
        </gr-col>
            ...
            <template slot-scope="scope">
              <gr-button-group>
                <gr-button class="el-icon-view" type="primary" @click.native.prevent="showInfo(scope.row.id,'view')"
                  v-apiauth:orgconfigdialog :url="apiUrls.info">查看</gr-button>
                <gr-button class="el-icon-edit" @click.native.prevent="showInfo(scope.row.id,'edit')"
                  v-apiauth:orgconfigdialog :url="apiUrls.update" type="warning">修改</gr-button>
              </gr-button-group>
            </template>
          </gr-table-column>
        </gr-table>
    ...
    <!-- <div v-show="showForm"> -->
    <!-- <orgconfig-form :showForm.sync="showForm" :formData="formData" :formType="formType" @loadlist="getList"> -->
    <!-- </orgconfig-form> -->
    <!-- </div> -->
    <orgconfig-form-dialog :showForm.sync="showForm" :formType="formType" :formData="formData"></orgconfig-form-dialog>
  </div>
</template>

<script>
  // import orgconfigForm from './orgconfig-form';
  import orgconfigFormDialog from './orgconfig-form-dialog';
